...
typedef NS_ENUM(NSInteger, QMImagePositionType) {
    QMImagePositionTypeLeft,   //图片在左，标题在右，默认风格
    QMImagePositionTypeRight,  //图片在右，标题在左
    QMImagePositionTypeTop,    //图片在上，标题在下
    QMImagePositionTypeBottom  //图片在下，标题在上
};

typedef NS_ENUM(NSInteger, QMEdgeInsetsType) {
    QMEdgeInsetsTypeTitle,//标题
    QMEdgeInsetsTypeImage//图片
};

typedef NS_ENUM(NSInteger, QMMarginType) {
    QMMarginTypeTop         ,
    QMMarginTypeBottom      ,
    QMMarginTypeLeft        ,
    QMMarginTypeRight       ,
    QMMarginTypeTopLeft     ,
    QMMarginTypeTopRight    ,
    QMMarginTypeBottomLeft  ,
    QMMarginTypeBottomRight
};
